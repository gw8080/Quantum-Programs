...
Instead of a classical supercomputer attempting to solve a large problem that takes one second of compute time per attempt and considering the quantum computer is running at a 10 nanosecond latency and assuming multiple qubits that process instantly, the quantum computer is 100,000,000 times faster than the super computer, a very good example of the performance increase is: a problem that may take 100 million years to solve can be done in just one year...
